...
const upsertProject = require('../lib/actions/project/upsertProject');

const fs = require('fs');
describe('Project Test', function searchObject() {
    const credential1 = {
    ...
    cfgs.forEach(cfg => {
        ...
        describe('ActionUpsertProject ', function VerifyCredentialsTests() {
            it('ActionUpsertProject', async function ActionUpsertProject() {
                const emitter = new TestEmitter();
                const msg = {
                    body: {
                        project: {
                           // id: ff280e08-af3e-4034-b76f-87df6ad84fb9,//pass the Project id in case of update/put methods(mendatory) & dont pass externalid.
                            externalId: 5757,//pass externalId for Post method. 
                            name: 'MagicSoft',
                            active: false
                        }
                    }
                };
                await upsertProject.process.call(emitter, msg, cfg);
