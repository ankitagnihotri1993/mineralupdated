...
const searchAPI = require('../lib/triggers/searchObject');

const fs = require('fs');
describe('Search Test', function searchObject() {
    const credential1 = {
    ...
    cfgs.forEach(cfg => {
        ...
        describe('TriggerSearchObject ', function VerifyCredentialsTests() {
            it('TriggerSearchObject', async function TriggerSearchObject() {
                ...
                await searchAPI.process.call(emitter, msg, cfg);
