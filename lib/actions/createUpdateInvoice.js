...
async function processAction(msg, cfg) {
    ...
    console.log('invoicedata' + JSON.stringify(msg.body.InvoiceDetails));
    console.log('subsidiaryId' + JSON.stringify(msg.body.SubsidiaryId));
    ...
    if (!utility.isEmpty(invoice) && !utility.isEmpty(subsidiaryId)) {
            ...
            let invoiceBody = await GetMTInvoiceBody(cfg, etag, invoice, subsidiaryId);
