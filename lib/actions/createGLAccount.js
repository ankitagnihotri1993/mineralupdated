    ...
    if(msg.body.glAccount.ClientInfo!=undefined && msg.body.glAccount.ClientInfo!=null && msg.body.glAccount.ClientInfo!="")
     {
         ...
         {
          subsidiary: {
           externalId: msg.body.glAccount.ClientInfo.ClientID,
           name: msg.body.glAccount.ClientInfo.ClientName,
           externalParentId: msg.body.glAccount.ClientInfo.ClientID
       }
    }
    console.log("clientbody "+ JSON.stringify(clientbody));

    invoiceService.createSubsidiary(clientbody,cfg, etag).then(function(subsidiaryResult){
        if (subsidiaryResult != null && subsidiaryResult != undefined && subsidiaryResult!="") 
        {
       
       console.log("subsidiaryResult "+ JSON.stringify(subsidiaryResult));
      
       msg.body={ glAccount: {
            subsidiaries: [{
                id: subsidiaryResult.id
                } ], 
