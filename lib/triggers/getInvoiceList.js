...
function processTrigger(msg, cfg,snapshot) 
{
    ...
    return accountService.login(cfg).then(function (response) {
        ...
        return commonsService.searchObjects(cfg, etag,body.body).then(async function (response) {
         
           console.log("invoice Data"+JSON.stringify(response.entities));
           ...
           var filterData =  response.entities.filter(res =>
            ...
            console.log("Invoice Filter Data "+JSON.stringify(element));
